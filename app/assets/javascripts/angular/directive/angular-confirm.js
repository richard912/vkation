...
angular.module('angular-confirm', ['ui.bootstrap'])
        ...
        .value('$confirmModalDefaults', {
            template: '<div class="modal-header"><h3 class="modal-title">Confirm</h3></div><div class="modal-body">{{data.text}}</div><div class="modal-footer"><span><button class="btn btn-primary" ng-click="ok()">OK</button></span>&nbsp;<span><button class="btn btn-warning" ng-click="cancel()">Cancel</button></span></div>',
